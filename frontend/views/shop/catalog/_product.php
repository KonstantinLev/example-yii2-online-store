    ...
    <div class="product-thumb">
        ...
        <div>
            ...
            <div class="button-group">
                ...
                <button type="button" data-toggle="tooltip" title="Add to Wish List" href="<?= Url::to(['/profile/wishlist/add', 'id' => $product->id]) ?>" data-method="post"><i class="fa fa-heart"></i></button>
